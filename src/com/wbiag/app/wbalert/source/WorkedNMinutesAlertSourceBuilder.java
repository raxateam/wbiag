...
public class WorkedNMinutesAlertSourceBuilder extends AbstractWBAlertSourceBuilder {
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(WorkedNMinutesAlertSourceBuilder.class);

	public WorkedNMinutesAlertSourceBuilder() {}
	
	public String getTaskParametersUI() {
			System.out.println("GETTING TASK PARAMETERS UI");
	        return "/jobs/wbalert/WorkedNMinutesAlertParams.jsp";
	}
	...
	public RowSource getRowSource(java.io.Serializable param, DBConnection conn) {
	        ...
	        try 
	        {
	            return new WorkedNMinutesAlertSource(conn, exportParam);
	        } catch (Exception ex) {
