...
*/
public class ClockAlertSourceBuilder extends AbstractWBAlertSourceBuilder {
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(ClockAlertSourceBuilder.class);

	/** Does nothing. */
    public ClockAlertSourceBuilder()  {}
    ...
    public RowSource getRowSource(java.io.Serializable param, DBConnection conn) {
        ...
        try {
            return new ClockAlertSource(conn, exportParam);
        } catch (Exception ex) {
