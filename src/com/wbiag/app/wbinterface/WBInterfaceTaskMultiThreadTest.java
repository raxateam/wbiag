 ...
 *
 */
public class WBInterfaceTaskMultiThreadTest extends WBInterfaceCustomTestCase {
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(WBInterfaceTaskMultiThreadTest.class);
    ...
    private String EMPBDG_BADGE_NUMBER_COL  = "";
    ...
    public WBInterfaceTaskMultiThreadTest(String testName) throws Exception {
        super(testName);
    }

    public static TestSuite suite() {
        TestSuite result = new TestSuite();
        result.addTestSuite(WBInterfaceTaskMultiThreadTest.class);
        return result;
    }
    ...
    public void testMultiThread() throws Exception{
        ...
        runWBInterfaceTaskByTransactionId(createDefaultHRTransactionParams() ,
                                          trans.getWbitranId());
    ...
    /**
     * Runs import interface task for given transaction id.
     * @param param param
     * @param transId transId
     * @throws Exception
     */
    public void runWBInterfaceTaskByTransactionId(
        HashMap param,
        int transId) throws Exception {

        param.put(WBInterfaceTaskMultiThread.PARAM_PARTITION_COLUMN_NAME, "C");
        param.put(WBInterfaceTaskMultiThread.PARAM_THREAD_COUNT, "1");
        WBInterfaceTaskMultiThread taskM = new WBInterfaceTaskMultiThread();
        taskM.setCheckForInterrupt(false);
        taskM.setTransactionParam( param );
        int cnt = taskM.executeByTransactionId(getConnection(), transId);
        assertTrue("1 Transaction must be processed" , cnt ==1);
    }
    ...
    private String createData(){
        ...
        EMPBDG_BADGE_NUMBER_COL = EMP_NAME_COL;
