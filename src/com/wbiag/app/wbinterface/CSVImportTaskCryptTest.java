 ...
 *
 */
public class CSVImportTaskCryptTest extends WBInterfaceCustomTestCase{
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(CSVImportTaskCryptTest.class);
    ...
    public CSVImportTaskCryptTest(String testName) throws Exception {
        super(testName);
    }

    public static TestSuite suite() {
        TestSuite result = new TestSuite();
        result.addTestSuite(CSVImportTaskCryptTest.class);
        return result;
    }
    ...
    public void testCrypt() throws Exception{
        ...
        updateWbintTypeClass(typId , "com.wbiag.app.wbinterface.hr2.CSVImportTaskCrypt");

        String path = createFile(createData(false));
        String encPath = path + ".enc";
        CryptUtil.encryptDecryptFile(path, encPath, CryptUtil.MODE_ENCRYPT);
        TransactionData trans = importCSVFile(encPath ,
    ...
    public TransactionData importCSVFile(String filePath ,
        ...
        CSVImportTaskCrypt csvTask = new CSVImportTaskCrypt();
        csvTask.setCheckForInterrupt(false);
        List trList = csvTask.importCSVOneClient(
                getConnection(),
                transformer,
                wbitypName,
                filePath,
