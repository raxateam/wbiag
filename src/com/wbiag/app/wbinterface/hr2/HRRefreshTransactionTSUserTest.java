...
/**
 * Unit test for updating TS_USER table
 *
 */
public class HRRefreshTransactionTSUserTest extends WBInterfaceCustomTestCase {
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(HRRefreshTransactionTSUserTest.class);
    ...
    private final String TS_USER_COL_UPDATE = "2";
    private final String TS_USER_COL_UPDATE_ERROR = "3";

    private final String typName = "HR REFRESH";
    private final int typId = 1;


    public HRRefreshTransactionTSUserTest(String testName) throws Exception {
        super(testName);
    }

    public static TestSuite suite() {
        TestSuite result = new TestSuite();
        result.addTestSuite(HRRefreshTransactionTSUserTest.class);
        return result;
    }
     ...
     * @throws Exception
     */
    public void testInsertTsUser() throws Exception{

        updateWbintTypeClass(typId , "com.wbiag.app.wbinterface.hr2.HRRefreshTransactionTSUser");
     ...
     * @throws Exception
     */
    public void testUpdateTsUser() throws Exception{
        ...
        assertEquals("Timesheet flag", Integer.parseInt(TS_USER_COL_UPDATE) , getTSUserTimeSheetFlag(ed.getEmpId()));
    }

    /**
      * Tests if one record fails, all batch doesnt fail
      * @throws Exception
      */
     public void testError() throws Exception{
         ...
         String empName1 = "2015", empName2 = "2016";
         String path = createFile(createErrorData(empName1 , empName2));
         ...
         List imports = getImportsByTransactionId(trans.getWbitranId());
         System.out.println(imports);
         assertTrue(imports.size() == 2 );
         ImportData id2 = (ImportData)imports.get(1);
         assertTrue(id2.isError());
         ImportData id1 = (ImportData)imports.get(0);
         assertTrue(id1.isApplied());
    ...
    private String createUpdateData(String empName){
        ...
        stm += "," + TS_USER_COL_UPDATE ;
        return stm;
    }

    private String createErrorData(String empName1, String empName2){
