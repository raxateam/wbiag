 ...
 *
 */
public class HRRefreshTransactionWbuExtraTest extends WBInterfaceCustomTestCase {
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(HRRefreshTransactionWbuExtraTest.class);
    ...
    private final String WBUEXTRA   = "WBU_FLAG1=Y";
    private final String WBUEXTRA_UPDATE = "WBU_FLAG1=N";

    private final String typName = "HR REFRESH";
    private final int typId = 1;


    public HRRefreshTransactionWbuExtraTest(String testName) throws Exception {
        super(testName);
    }

    public static TestSuite suite() {
        TestSuite result = new TestSuite();
        result.addTestSuite(HRRefreshTransactionWbuExtraTest.class);
        return result;
    }
    ...
    public void testNewEmp() throws Exception{
        ...
        updateWbintTypeClass(typId , "com.wbiag.app.wbinterface.hr2.HRRefreshTransactionWbuExtra");
