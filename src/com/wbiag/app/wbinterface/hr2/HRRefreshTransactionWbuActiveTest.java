 ...
 */
public class HRRefreshTransactionWbuActiveTest extends WBInterfaceCustomTestCase {
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(HRRefreshTransactionWbuActiveTest.class);
    ...
    private final String WBU_NAME_COL             = EMP_NAME_COL;
    ...
    private final String WBUACTIVE   = "Y";
    private final String WBUACTIVE_UPDATE = "N";

    private final String typName = "HR REFRESH";
    private final int typId = 1;


    public HRRefreshTransactionWbuActiveTest(String testName) throws Exception {
        super(testName);
    }

    public static TestSuite suite() {
        TestSuite result = new TestSuite();
        result.addTestSuite(HRRefreshTransactionWbuActiveTest.class);
        return result;
    }
    ...
    public void testNewEmp() throws Exception{
        ...
        updateWbintTypeClass(typId , "com.wbiag.app.wbinterface.hr2.HRRefreshTransactionWbuActive");
        ...
        WorkbrainUserAccess wa = new WorkbrainUserAccess(c);
        WorkbrainUserData wd = wa.loadByEmpId(ed.getEmpId() );
        assertNotNull(wd);

        assertEquals(WBUACTIVE , wd.getWbuActive());
    }

    /**
     * @throws Exception
     */
    public void xExistingEmp() throws Exception{
        getConnection().setCodeMapper(getCodeMapper());
        updateWbintTypeClass(typId , "com.wbiag.app.wbinterface.hr2.HRRefreshTransactionWbuActive");
        ...
        assertNotNull(wd);
        assertEquals(WBUACTIVE_UPDATE , wd.getWbuActive());
