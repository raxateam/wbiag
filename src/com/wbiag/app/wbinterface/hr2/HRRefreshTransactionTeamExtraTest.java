 ...
 *
 */
public class HRRefreshTransactionTeamExtraTest extends WBInterfaceCustomTestCase {
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(HRRefreshTransactionTeamExtraTest.class);
    ...
    private final String USERTEAMROLE = "SUPERVISOR";
    private final String TEAM_DESC = "Test";
    private final String USERTEAMROLE_COL         = "WBROLE_NAME=" + USERTEAMROLE + "~WBT_DESC=" + TEAM_DESC;
    private final String TEAM_DESC_UPDATE = "Test Update";
    private final String USERTEAMROLE_COL_UPDATE = "WBROLE_NAME=" + USERTEAMROLE + "~WBT_DESC=" + TEAM_DESC_UPDATE;

    private final String typName = "HR REFRESH";
    private final int typId = 1;


    public HRRefreshTransactionTeamExtraTest(String testName) throws Exception {
        super(testName);
    }

    public static TestSuite suite() {
        TestSuite result = new TestSuite();
        result.addTestSuite(HRRefreshTransactionTeamExtraTest.class);
        return result;
    }
    ...
    public void testInsertTeamExtra() throws Exception{
        ...
        updateWbintTypeClass(typId , "com.wbiag.app.wbinterface.hr2.HRRefreshTransactionTeamExtra");
        ...
        assertEquals("User Role", USERTEAMROLE ,
    ...
    public void testUpdateTeamExtra() throws Exception{
        ...
        WorkbrainTeamData wbt = new WorkbrainTeamAccess(c).loadByName(EMPT_NAME_COL);
        assertNotNull(wbt);
        assertEquals(TEAM_DESC_UPDATE , wbt.getWbtDesc());
