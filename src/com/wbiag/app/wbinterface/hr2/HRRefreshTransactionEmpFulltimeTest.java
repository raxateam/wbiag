 ...
 *
 */
public class HRRefreshTransactionEmpFulltimeTest extends WBInterfaceCustomTestCase {
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(HRRefreshTransactionEmpFulltimeTest.class);
    ...
    private final String EMP_FULLTIME   = "Y";
    private final String EMP_FULLTIME_UPDATE = "N";

    private final String typName = "HR REFRESH";
    private final int typId = 1;


    public HRRefreshTransactionEmpFulltimeTest(String testName) throws Exception {
        super(testName);
    }

    public static TestSuite suite() {
        TestSuite result = new TestSuite();
        result.addTestSuite(HRRefreshTransactionEmpFulltimeTest.class);
        return result;
    }
    ...
    public void testNewEmp() throws Exception{
        ...
        updateWbintTypeClass(typId , "com.wbiag.app.wbinterface.hr2.HRRefreshTransactionEmpFulltime");
        ...
        assertEquals(EMP_FULLTIME , ed.getEmpFulltime());
    }
    ...
    public void testExistingEmp() throws Exception{
        ...
        assertEquals(EMP_FULLTIME_UPDATE , ed.getEmpFulltime());
    }
