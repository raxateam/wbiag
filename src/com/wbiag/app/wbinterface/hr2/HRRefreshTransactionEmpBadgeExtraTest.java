 ...
 *
 */
public class HRRefreshTransactionEmpBadgeExtraTest extends WBInterfaceCustomTestCase {
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(HRRefreshTransactionEmpBadgeExtraTest.class);
    ...
    private final String EMP_BDG_EXTRA_COL   = "EMPBDG_FLAG1=Y~EMPBDG_UDF1=TEST";

    private final String typName = "HR REFRESH";
    private final int typId = 1;


    public HRRefreshTransactionEmpBadgeExtraTest(String testName) throws Exception {
        super(testName);
    }

    public static TestSuite suite() {
        TestSuite result = new TestSuite();
        result.addTestSuite(HRRefreshTransactionEmpBadgeExtraTest.class);
        return result;
    }
     ...
     * @throws Exception
     */
    public void testEmpBdgExtra() throws Exception{

        updateWbintTypeClass(typId , "com.wbiag.app.wbinterface.hr2.HRRefreshTransactionEmpBadgeExtra");
        ...
        EmployeeBadgeData ebd = new EmployeeBadgeAccess(c).loadByEmpId(ed.getEmpId() );
        assertEquals("Y", ebd.getEmpbdgFlag1());
        assertEquals("TEST", ebd.getEmpbdgUdf1());
    }
