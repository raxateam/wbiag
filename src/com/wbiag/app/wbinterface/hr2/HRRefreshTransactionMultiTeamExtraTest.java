...
/**
 * Unit test for updating User Team privileges
 *
 */
public class HRRefreshTransactionMultiTeamExtraTest extends WBInterfaceCustomTestCase {
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(HRRefreshTransactionMultiTeamExtraTest.class);

    private final long index = System.currentTimeMillis();
    private  String OVR_START_DATE_COL       = "";
    private  String OVR_END_DATE_COL         = "";
    ...
    private final String USERTEAM1                = "OFFICE";
    private final String USERTEAM2                = "IT";
    private final String USERTEAM3                = "MAINTENANCE";
    private final String USERTEAMROLE1 = "SUPERVISOR";
    private final String USERTEAMROLE2 = "SUPERVISOR";
    private final String TEAM_DESC = "Test Update";
    private final String USERTEAMROLE_COL         = USERTEAM1 + "~" + USERTEAMROLE1 + "~ADD|" + USERTEAM2 + "~" + USERTEAMROLE2 + "~ADD";
    private final String TEAM_DESC_UPDATE = TEAM_DESC;
    private final String USERTEAMROLE_COL_UPDATE = USERTEAM3 + "~" + USERTEAMROLE2 + "~UPDATE";
    private final String USERTEAMROLE_COL_DELETE = USERTEAM1 + "~" + USERTEAMROLE1 + "~DELETE|" + USERTEAM2 + "~" + USERTEAMROLE2 + "~DELETE|" + USERTEAM3 + "~" + USERTEAMROLE2 + "~DELETE";

    private final String typName = "HR REFRESH";
    private final int typId = 1;


    public HRRefreshTransactionMultiTeamExtraTest(String testName) throws Exception {
        super(testName);
    }

    public static TestSuite suite() {
        TestSuite result = new TestSuite();
        result.addTestSuite(HRRefreshTransactionMultiTeamExtraTest.class);
        return result;
    }
     ...
     * @throws Exception
     */
    public void testDeleteTeamExtra() throws Exception{

        updateWbintTypeClass(typId , "com.wbiag.app.wbinterface.hr2.HRRefreshTransactionMultiTeamExtra");

        String empName = "2015";
        String path = createFile(createDeleteData(empName));
        ...
        assertNotNull(ed);
        String wbuId = WorkbrainUserAccess.retrieveWbuIdByEmpId(c , ed.getEmpId());

        this.assertNotSame("User Role", USERTEAMROLE1 ,
                     getUserTeamRole(Integer.parseInt(wbuId)));

        WorkbrainTeamData wbt = new WorkbrainTeamAccess(c).loadByName(EMPT_NAME_COL);
        assertNotNull(wbt);
        //assertEquals(TEAM_DESC , wbt.getWbtDesc());
    }
     ...
     * @throws Exception
     */
    public void testInsertTeamExtra() throws Exception{

        updateWbintTypeClass(typId , "com.wbiag.app.wbinterface.hr2.HRRefreshTransactionMultiTeamExtra");
        String empName = "2015";

        String path = createFile(createData(empName));
        TransactionData trans = importCSVFile(path ,
                                              new HRFileTransformer() ,
                                              typName);
        ...
        assertEquals("User Role", USERTEAMROLE1 ,
                     getUserTeamRole(Integer.parseInt(wbuId)));

        WorkbrainTeamData wbt = new WorkbrainTeamAccess(c).loadByName(EMPT_NAME_COL);
        assertNotNull(wbt);
        assertEquals("Team Desc", TEAM_DESC , wbt.getWbtDesc());
    }

    /**
     * @throws Exception
     */
    public void testUpdateTeamExtra() throws Exception{
    ...
    private String createData(String empName){
   ...
   */
           ...
           stm += ",";
           stm += ",";
           stm += "," + USERTEAMROLE_COL ;
           stm += "," + TEAM_DESC_UPDATE ;

           return stm;
       }

    private String createDeleteData(String empName){
