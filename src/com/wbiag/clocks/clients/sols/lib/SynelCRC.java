 ...
 */
public class SynelCRC implements CRCBuilder{
     ...
     */
    public void checkCRC(String input) throws BadCRCException{
        
        if (input == null || input.length() < 5) {
            throw new BadCRCException("No CRC received. Input is too short: " + input);
        }
        ...
        if (!result) {
            throw new BadCRCException("Input CRC: \"" + iCrc + "\" Calculated CRC: \"" + cCrc.toString() + "\"");
        }
    }
