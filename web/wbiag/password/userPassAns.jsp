...
<wb:page uiPathName='Password Question Answer' showUIPath='false' enableFloaters="true">
...
<%
	String mfrm_id = request.getParameter("mfrm_id");
...
<div  class='contentTableTitle'><wb:localize id="QUESTION">User Password Verification Question and Answer</wb:localize></div>
<div class='separatorLarge'/>
...
%>
<input type="hidden" name="mfrm_id" value="<%= mfrm_id %>"/>
		  ...
		  <tr>
			<td>
				<table cellspacing='1' cellpadding='1' border='0'>
				  <tr>
					<td nowrap style='color:#000000; font:12 Arial,sans-serif;'><wb:localize id="Question">Question</wb:localize></td>
					<td>
				  ...
				  <tr>
					<td nowrap style="color:#000000; font:12 Arial,sans-serif;"><wb:localize id="Answer">Answer</wb:localize></td>
					<td>
					  <wb:controlField cssClass="inputField"
...
<wba:button type="html" label="Save" labelLocalizeIndex="Save" onClick="if(!( validateFormFieldsWithButtonsDisabled(this, 'return true') && !wasSubmitted() )) return false; setUIPathlabel('Password Question Answer');document.forms.page_form.to_do.value='save'; document.forms.page_form.submit(); return false;"/>
